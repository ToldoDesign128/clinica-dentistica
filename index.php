...
<section id="hero" class="h-screen">
    <div class="h-full flex lg:flex-row flex-col bg-gradient-to-r from-blue-100 to-blue-400 overflow-clip relative">
        <div class="h-full 3xl:w-2/5 lg:w-1/2 w-full flex flex-col flex-wrap self-center lg:justify-center justify-normal lg:mt-20 mt-48 lg:py-24 py-12 px-6 z-10">
